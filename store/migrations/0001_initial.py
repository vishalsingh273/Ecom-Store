    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('title', models.CharField(max_length=100)),
                ('section_type', models.CharField(choices=[('hero', 'Hero Banner'), ('category', 'Category Showcase'), ('deal', 'Special Deal'), ('product_grid', 'Product Grid'), ('brand_showcase', 'Brand Showcase')], max_length=20)),
                ('is_active', models.BooleanField(default=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('section', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='contents', to='store.homepagesection')),
            ],
            options={
                'ordering': ['order'],
            },
